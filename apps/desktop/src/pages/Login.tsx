...
import { Layers3, Eye, EyeOff, User, Lock, LogIn, AlertCircle } from 'lucide-react';
          ...
          <Card className="shadow-2xl border border-border bg-card/95 backdrop-blur-md">
            <CardHeader className="text-center pb-3 pt-7">
              ...
              <CardTitle className="text-xl font-extrabold tracking-tight">
                <h1 className="inline-block text-xl font-extrabold tracking-tight">ProjectHub</h1> {t('loginTitle')}
              </CardTitle>
