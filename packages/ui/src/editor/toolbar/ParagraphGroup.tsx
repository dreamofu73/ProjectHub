    ...
    <div className="flex items-center gap-0.5 border-r border-border pr-2">
      ...
      <div className="relative" ref={popovers.refs.align}>
        ...
        {popovers.isOpen('align') && (
          <div className={`${MENU_PANEL_CLASS} dark:border-slate-700 shadow-lg p-1 flex flex-col gap-0.5`} onKeyDown={popovers.handleMenuKeyDown}>
      ...
      <div className="relative" ref={popovers.refs.list}>
        ...
        {popovers.isOpen('list') && (
          <div className={`${MENU_PANEL_CLASS} dark:border-slate-700 shadow-lg p-2 flex flex-col gap-2 w-max`} onKeyDown={popovers.handleMenuKeyDown}>
      ...
      <div className="relative" ref={popovers.refs.lineHeight}>
        ...
        {popovers.isOpen('lineHeight') && (
          <div className={`${MENU_PANEL_CLASS} dark:border-slate-700 shadow-lg p-1 flex flex-col gap-0.5 w-24`} onKeyDown={popovers.handleMenuKeyDown}>
            {LINE_HEIGHTS.map(lh => (
              <button
                key={lh}
                type="button"
